<%--
 Qui c'è il codice per recuperare i file degli Accessori
--%>
<!DOCTYPE html>
<html>
<head>
...
<h1 class="Slogan">Accessori</h1> <!-- Sto coso mi serve per tenere separati le barre e l'header che sennò sono appiccicati -->
